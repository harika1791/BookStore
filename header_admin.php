        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="shake">
                    <img src="images/logo.png" alt="jusBooks logo" class="hidden-xs">
                    <img src="images/logo.png" alt="jusBooks logo" class="visible-xs"><span class="sr-only">jusBooks - homepage</span>
                </a>
