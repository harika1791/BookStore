...
?>
<?php 
    $query = "Select * from upcoming where  del=0;";
                                ...
                                <div class="row">
                                    <div class="form-inline">
                                        <div class="col-md-6 col-sm-6">
                                            <form action="searchbyprice.php?id=1&book=u" method="post" >
                      ...
                      <div class=" col-md-2 item" >
                        ...
                        <div class="product" style="width:165px;">
                            <div class=="flip-container" >
                                <div class="flipper" >
                                        <div class="front" >
                                            <a href="upcoming_detail.php?ID=<?php echo $book_cat['BookID'];?>">
                                                <?php echo'
                                                <img src="https://storage.googleapis.com/justbooks/upcoming/images/'.$book_cat['Image']. '" alt="" class="img-responsive">'; 
                                                ?>
                                            </a>
                                ...
                                <a href="upcoming_detail.php?ID=<?php echo$book_cat['BookID'];?>" class="invisible">
                                    <img src="" alt="" class="img-responsive">
                                </a>
                                <div class="text" style="height:75px; text-align: center;">
                                    <h4 style=" width:135px; overflow:hidden; white-space:nowrap; "><a href="upcoming_detail.php?ID=<?php echo $book_cat['BookID'];?>" title="<?php echo $book_cat['title'];?>"><?php echo $book_cat['title']; ?></a></h4>
